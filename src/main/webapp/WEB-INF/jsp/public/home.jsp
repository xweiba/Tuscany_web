...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath }/static/images/453254312.png">${studentCount}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${pageContext.request.contextPath }/static/images/453254312.png">${countWorkStundet}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <%-- 遍历 学员列表 StudentList --%>
            <c:forEach items="${superStudent}" var="student">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${pageContext.request.contextPath }/static/images/242424.png">
                            <span>${student.stuName}:${student.stuTitle}</span>
                            <p class="text-left">${student.declaration}</p>
                        </div>
                    </li>
            </c:forEach>
        </ul>
